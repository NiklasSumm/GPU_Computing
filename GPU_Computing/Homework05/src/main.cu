...
main(int argc, char * argv[])
{
    ...
    cudaMalloc((void **) &d_matrixA, static_cast<size_t>(matrixSize * sizeof(*d_matrixA)));
    cudaMalloc((void **) &d_matrixB, static_cast<size_t>(matrixSize * sizeof(*d_matrixB)));
    cudaMalloc((void **) &d_matrixC, static_cast<size_t>(matrixSize * sizeof(*d_matrixC)));
