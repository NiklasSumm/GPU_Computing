...
def main():
    ...
    with open("QuantW_TAQ_bitWidth" + str(args.bit_width) + "_Accuracy_time.csv", 'w', newline='') as csvfile:
        fieldnames = ["Time", "Accuracy"]
        writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
        writer.writeheader()
        writer.writerows(data_time)

    with open("QuantW_TAQ_bitWidth" + str(args.bit_width) + "_Accuracy.csv", 'w', newline='') as csvfile:
