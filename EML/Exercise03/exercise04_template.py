...
def main():
    ...
    dataset_train = datasets.CIFAR10('../data', split='train', download=True, transform=train_transforms)
    dataset_test = datasets.CIFAR10('../data', split='test', download=True, transform=test_transforms)
